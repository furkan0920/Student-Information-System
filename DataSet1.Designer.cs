...
namespace E_okul.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT TBL_KULUPLER.KULUPAD, TBL_OGRENCILER.OGRID, TBL_OGRENCILER.OGRAD, TBL_OGRE" +
                "NCILER.OGRSOYAD, TBL_OGRENCILER.OGRCINSIYET\r\nFROM     TBL_KULUPLER INNER JOIN\r\n " +
                "                 TBL_OGRENCILER ON TBL_KULUPLER.KULUPID = TBL_OGRENCILER.OGRKULU" +
                "P";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT TBL_KULUPLER.KULUPAD, TBL_OGRENCILER.OGRID, TBL_OGRENCILER.OGRAD, TBL_OGRENCILER.OGRSOYAD, TBL_OGRENCILER.OGRCINSIYET
FROM     TBL_KULUPLER INNER JOIN
...
WHERE  (TBL_OGRENCILER.OGRAD = @OGRAD)";
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE TBL_OGRENCILER\r\nSET          OGRAD = @OGRAD, OGRSOYAD = @OGRSOYAD, OGRCINS" +
                "IYET = @OGRCINSIYET, OGRKULUP = @OGRKULUP";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual DataSet1.DataTable1DataTable OgrenceBul(string OGRAD) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((OGRAD == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int OgrenciGuncelle(string OGRAD, string OGRSOYAD, string OGRCINSIYET, global::System.Nullable<byte> OGRKULUP) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((OGRAD == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
